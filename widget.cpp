...
void Widget::on_Botton_1_clicked()
{
...
void Widget::on_savecolor_clicked()
{
     ...
     SaveColor("Button 2",ColorList[2]);
     SaveColor("Button 3",ColorList[3]);
     SaveColor("Button 4",ColorList[4]);
     SaveColor("Button 5",ColorList[5]);
     SaveColor("Button 6",ColorList[6]);
     SaveColor("Button 7",ColorList[7]);
     SaveColor("Button 8",ColorList[8]);
     SaveColor("Button 9",ColorList[9]);

}

void Widget::on_loadcolor_clicked()
{
   setLoadedColor("button 1",0,ui->Botton_1);
